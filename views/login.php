<link rel="stylesheet" href="<?= BASE_URL ?>styles/style.css">
  ...
  <div class="login-container">
    ...
    <form method="post" action="../testar/processa_login.php">
    ...
    <a href="#" class="back-link">Esqueci minha senha</a><br>
    <a href="?pagina=criar-conta" class="back-link">Não possuo conta</a>
  </div>
...
if (isset($_GET['erro'])) {
  if ($_GET['erro'] == 1) {
    echo '<div class="alert">Email e/ou senha inválido(s).</div>';
  } elseif ($_GET['erro'] == 2) {
    echo '<div class="alert">Você precisa estar logado para acessar esta página.</div>';
  }
}
?>
